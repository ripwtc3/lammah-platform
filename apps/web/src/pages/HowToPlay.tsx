...
const GAMES = [
  ...
  { name: "نبض القبو", desc: "اختر ممراً (1-3) كل جولة — كل ما اختار نفس الممر ناس أكثر، زاد خطر الإنذار عليه. الهدايا تمنح حصانة، والإعجابات تفتح القبو مبكراً." },
  { name: "مصعد الحظ 🎰", desc: "اختر باباً (1 أو 2) كل طابق — الباب الخاطئ يُسقطك ما لم يكتمل صندوق أمان جماعي من الإعجابات. الهدايا تمنحك تلميحاً خاصاً لا يراه أحد غيرك." },
  { name: "الحارس الآلي 🤖", desc: "لعبة تعاونية: صوّتوا برقم منفذ (1-5) لضرب درع الحارس — الحارس يتعلّم من تصويتكم ويصدّ المنفذ الأكثر تكراراً، فنوّعوا اختياركم!" },
  { name: "الضباب الأخير 🌫️", desc: "كل جولة شخص عشوائي يصير 'الصياد' والباقي أشباح يختبئون برقم منطقة — إذا خمّن الصياد منطقتك تُقصى. الإعجابات تمنح الصياد فرص تخمين أكثر." },
];
